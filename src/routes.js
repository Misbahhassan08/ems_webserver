...
import ReportingDropdown from './views/dashboard/projectReporting.js'
import Pergateway from './views/dashboard/pergateway.js'
import AnalyzerReporting from './views/dashboard/analyzerReporting.js'
...
const routes = [
  ...
  { path: '/dashboard/project_data' , name: 'Project Data', element: ProjectData},
  { path: '/dashboard/gateway_data' , name: 'Gateway Data', element: GatewayData},
